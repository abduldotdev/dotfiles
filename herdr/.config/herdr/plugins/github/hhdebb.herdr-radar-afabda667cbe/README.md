...
| `worktree_mark` | `U+F418` | the mark on a worktree header and in front of the branch on a Space's row, needs a Nerd Font; empty for none |
...
terminals: map `U+E1A0–U+E1B7`, `U+E1C0–U+E1C5` and `U+E1D0–U+E1E7` by hand. Terminals with no codepoint map
